...
from tgytdlp.telegram.handlers.start import handle_start, is_start_command
from tgytdlp.telegram.handlers.urls import extract_url, handle_url
from tgytdlp.telegram.ids import as_mapping, chat_id_from_message, message_id_from, user_id_from


def process_update(api: BotAPI, settings: Settings, store: Store, update: Mapping[str, object]) -> None:
    message = as_mapping(update.get("message"))
